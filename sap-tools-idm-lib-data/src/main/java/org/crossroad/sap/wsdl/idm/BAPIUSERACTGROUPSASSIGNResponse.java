 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ACTIVITYGROUPS" type="{urn:sap-com:document:sap:rfc:functions}TABLE_OF_BAPIAGR"/&gt;
...
@XmlRootElement(name = "BAPI_USER_ACTGROUPS_ASSIGNResponse")
public class BAPIUSERACTGROUPSASSIGNResponse {

    @XmlElement(name = "ACTIVITYGROUPS", required = true)
