 ...
 *         &lt;element name="SYMB_DEST" type="{urn:sap-com:document:sap:rfc:functions}char10"/&gt;
 *         &lt;element name="REC_TYPE" type="{urn:sap-com:document:sap:rfc:functions}char1"/&gt;
 *         &lt;element name="R_MAIL_CLT" type="{urn:sap-com:document:sap:rfc:functions}char3"/&gt;
 *         &lt;element name="R_MAIL" type="{urn:sap-com:document:sap:rfc:functions}char12"/&gt;
...
public class BAPIADRML {
    ...
    @XmlElement(name = "SYMB_DEST", required = true)
    protected String symbdest;
    @XmlElement(name = "REC_TYPE", required = true)
    protected String rectype;
    @XmlElement(name = "R_MAIL_CLT", required = true)
    protected String rmailclt;
    @XmlElement(name = "R_MAIL", required = true)
